  ...
  try {
    ...
    if (!lead) {
      lead = {
        ...
        destination: body.destination || pkg.destination,
        travelDates: body.travelDates || 'Flexible',
        travelers: typeof body.travelers === 'number' && body.travelers > 0 ? body.travelers : 1,
        budgetPerPerson: typeof body.budgetPerPerson === 'number' && body.budgetPerPerson > 0 ? body.budgetPerPerson : pkg.pricePerPerson,
        tripStyle: body.tripStyle || pkg.category,
        packageId: pkg.id,
